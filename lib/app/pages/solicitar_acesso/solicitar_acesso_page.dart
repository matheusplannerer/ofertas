...
import 'package:ofertas/app/pages/solicitar_acesso/components/page_one/page_one_widget.dart';
import 'package:ofertas/app/pages/solicitar_acesso/components/page_two/page_two_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PageView(
        ...
        pageSnapping: false,
        children: <Widget>[
          PageOneWidget(controller),
          PageTwoWidget(controller),
        ],
      ),
    );
