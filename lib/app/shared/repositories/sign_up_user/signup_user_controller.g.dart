...
mixin _$SignUpController on _SignUpControllerBase, Store {
  ...
  final _$_nomeCompletoAtom = Atom(name: '_SignUpControllerBase._nomeCompleto');
  ...
  final _$_emailAtom = Atom(name: '_SignUpControllerBase._email');
  ...
  final _$_senhaAtom = Atom(name: '_SignUpControllerBase._senha');
  ...
  final _$_confirmSenhaAtom = Atom(name: '_SignUpControllerBase._confirmSenha');
  ...
  final _$_contatoAtom = Atom(name: '_SignUpControllerBase._contato');
  ...
  final _$erroNomeAtom = Atom(name: '_SignUpControllerBase.erroNome');
  ...
  final _$erroContatoAtom = Atom(name: '_SignUpControllerBase.erroContato');
  ...
  final _$erroEmailAtom = Atom(name: '_SignUpControllerBase.erroEmail');
  ...
  final _$erroSenhaAtom = Atom(name: '_SignUpControllerBase.erroSenha');
  ...
  final _$textErroValidateNomeAtom =
      Atom(name: '_SignUpControllerBase.textErroValidateNome');
  ...
  final _$textErroValidateContatoAtom =
      Atom(name: '_SignUpControllerBase.textErroValidateContato');
  ...
  final _$textErroValidateEmailAtom =
      Atom(name: '_SignUpControllerBase.textErroValidateEmail');
  ...
  final _$textErroValidateSenhaAtom =
      Atom(name: '_SignUpControllerBase.textErroValidateSenha');
  ...
  final _$erroCadastroAtom = Atom(name: '_SignUpControllerBase.erroCadastro');
  ...
  final _$createUserWithEmailAndPassAsyncAction =
      AsyncAction('createUserWithEmailAndPass');

  @override
  Future<FirebaseUser> createUserWithEmailAndPass() {
    return _$createUserWithEmailAndPassAsyncAction
        .run(() => super.createUserWithEmailAndPass());
  }
