...
part of 'feed_filtrado_controller.dart';
...
mixin _$FeedFiltradoController on _FeedFiltradoControllerBase, Store {
  ...
  final _$_empresasAtom = Atom(name: '_FeedFiltradoControllerBase._empresas');
  ...
  final _$_statusAtom = Atom(name: '_FeedFiltradoControllerBase._status');
  ...
  final _$_hasMoreAtom = Atom(name: '_FeedFiltradoControllerBase._hasMore');
  ...
  @override
  Future<dynamic> fetchPage(String categoria, {int limitQuery}) {
    return _$fetchPageAsyncAction
        .run(() => super.fetchPage(categoria, limitQuery: limitQuery));
  }

  final _$_FeedFiltradoControllerBaseActionController =
      ActionController(name: '_FeedFiltradoControllerBase');

  @override
  void setHasMore(bool value) {
    final _$actionInfo =
        _$_FeedFiltradoControllerBaseActionController.startAction();
    try {
      return super.setHasMore(value);
    } finally {
      _$_FeedFiltradoControllerBaseActionController.endAction(_$actionInfo);
    }
  }
