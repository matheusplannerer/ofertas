...
class HeaderEmpresaFeedWidget extends StatelessWidget {
  final PerfilEmpresaModel empresa;
  final PerfilEmpresaFeedController controller;
  HeaderEmpresaFeedWidget(this.empresa, {this.controller});
                ...
                IconButton(
                  onPressed: () {
                    ...
                    routeController.actualNavigator.currentState.pushNamed(
                      '/empresa/${empresa.empresaID}/horarios',
                      arguments: empresa,
                    );
                  },
