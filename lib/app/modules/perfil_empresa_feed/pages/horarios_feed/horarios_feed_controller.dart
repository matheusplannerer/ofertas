...
part 'horarios_feed_controller.g.dart';

class HorariosFeedController = _HorariosFeedControllerBase
    with _$HorariosFeedController;

abstract class _HorariosFeedControllerBase with Store {
  AuthController authController = Modular.get();
  RouteController routeController = Modular.get();
  AppController appController = Modular.get();

  final PerfilEmpresaModel empresa;
  _HorariosFeedControllerBase(this.empresa) {
    updateFields(this.empresa);
  }
