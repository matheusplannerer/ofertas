...
part 'pro_plan_controller.g.dart';

class ProPlanController = _ProPlanControllerBase with _$ProPlanController;

abstract class _ProPlanControllerBase with Store {
