...
part of 'master_plan_controller.dart';
...
mixin _$MasterPlanController on _MasterPlanControllerBase, Store {
  final _$mensalAtom = Atom(name: '_MasterPlanControllerBase.mensal');
  ...
  final _$semestralAtom = Atom(name: '_MasterPlanControllerBase.semestral');
  ...
  final _$anualAtom = Atom(name: '_MasterPlanControllerBase.anual');
  ...
  final _$_MasterPlanControllerBaseActionController =
      ActionController(name: '_MasterPlanControllerBase');

  @override
  void setMensal(bool value) {
    final _$actionInfo =
        _$_MasterPlanControllerBaseActionController.startAction();
    try {
      return super.setMensal(value);
    } finally {
      _$_MasterPlanControllerBaseActionController.endAction(_$actionInfo);
    }
  }
